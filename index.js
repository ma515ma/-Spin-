...
client.on("message",async message =>{
  ...
  .setColor("BLUE").setAuthor(message.author.username , message.author.displayAvatarURL({dynamic:true})).setTimestamp().setFooter("Hwashim", message.guild.iconURL()).setTitle("**Made by Hwashim**").addField("Spin Normel" , "تحتاج الى invites واحد للحصول على نقطه.").addField("Legend spin","تحتاج إلى invites اثنين للحصول على نقطتين.")
...
client.on("ready",()=>{
client.user.setActivity("Hwashim Luck.", { type: 'WATCHING' })
